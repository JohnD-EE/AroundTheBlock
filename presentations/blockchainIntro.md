...
* Quantum computing is baesed ib quantum mechanics
* Probability distributions - Quantum bits (qubits) utilise quantum superposition where a qubit can be in a state of zero or one and the whoe range of probabilities n between, as long as they are not observed.
* So due to superposition, a quantum computer can do many simultaneous calculations 
